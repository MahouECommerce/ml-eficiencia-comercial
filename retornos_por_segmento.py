...
segmentos_df= 'order_detail_grouped_nuevos_segmentos.parquet'
...
order_detail_grouped_segmentos=pd.read_parquet(f'{path}{segmentos_df}')
...
grupos = grupos = [
    {"nombre": "dormidos", "df": order_detail_grouped_segmentos[order_detail_grouped_segmentos['segmento'] == 'dormidos']},
    {"nombre": "offline", "df": order_detail_grouped_segmentos[order_detail_grouped_segmentos['segmento'] == 'offline']},
    {"nombre": "cuponeros", "df": order_detail_grouped_segmentos[order_detail_grouped_segmentos['segmento'] == 'cuponeros']},
    {"nombre": "optimos", "df": order_detail_grouped_segmentos[order_detail_grouped_segmentos['segmento'] == 'optimos']}
]
