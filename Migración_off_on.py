...
variables_comportamentales= order_detail_sorted [['Frequency_online', 'PctgCouponUsed', 'CouponDiscountAmt',
                ...
                'DaysBetweenPurchases', 'CumulativeAvgDaysBetweenPurchases','FrequencyTotal', 'NumeroReferenciasUnicas']]
...
#El método del codo indica seleccionar entre 3 y 4 clusters
...
variables=['Frequency_online', 'PctgCouponUsed', 'CouponDiscountAmt',
                ...
                'DaysSinceLastOnlinePurchase',
                'DaysBetweenPurchases', 'CumulativeAvgDaysBetweenPurchases','FrequencyTotal', 'NumeroReferenciasUnicas']
cluster_summary = order_detail_sorted.groupby('Cluster')[variables].mean().reset_index()
# print(cluster_summary)


#### TODO: meter la variable pointofsale para poder traernos otras variables para perfilar 
